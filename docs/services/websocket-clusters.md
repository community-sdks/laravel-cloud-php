# WebSocket Clusters Service

WebSocket cluster operations.

- PHP class: `CommunitySDKs\LaravelCloud\Services\WebSocketClustersService`
- Client accessor: `$cloud->webSocketClusters()`
